...
Rojo will create a file named `ProjectName.rbxlx` that contains your new game!

If you open `ProjectName.rbxlx` in Roblox Studio now, you should see a baseplate, as well as code in services like `ReplicatedStorage`.
