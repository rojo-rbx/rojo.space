...
<Tabs>
<TabItem value="rokit" label="With Rokit" default>

[Rokit] is our in-house toolchain manager that is useful for managing tools like Rojo for Roblox projects. To install it, follow these [instructions][rokit-installation-instructions].
...
[rokit-installation-instructions]: https://github.com/rojo-rbx/rokit#installation
